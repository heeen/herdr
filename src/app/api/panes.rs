...
mod tests {
    ...
    fn report_agent_lands_authoritative_state_for_live_pane() {
        ...
        // Upstream made full-lifecycle agents process-owned and session-anchored: a pi hook report
        // only lands authoritative state when the process is detected on screen AND the session is
        // anchored. Set both up so this still exercises the authority path.
        ...
        terminal.set_persisted_agent_session(crate::agent_resume::PersistedAgentSession {
            source: "herdr:pi".into(),
            agent: "pi".into(),
            session_ref: crate::agent_resume::AgentSessionRef::id("pi-session-1").unwrap(),
        });
