...
impl Workspace {
    ...
    pub(crate) fn sidebar_placeholder_with_tabs(
        ...
        // Upstream caches the derived label/git identity outside the render path (#1842); seed it
        // here so a sidebar-placeholder workspace matches one built by the normal constructors.
